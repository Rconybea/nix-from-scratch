...
[![Version](https://img.shields.io/badge/release-v0.38.0-blue)](https://github.com/Rconybea/nix-from-scratch/releases)
...
```
version=nix-from-scratch-0.38.0
...
1. Download release
  ...
  ```
  curl -L https://github.com/Rconybea/nix-from-scratch/archive/refs/tags/nix-from-scratch-0.38.0.tar.gz
  tar xf nix-from-scratch-0.38.0.tar.gz
  srcdir=nix-from-scratch-0.38.0
  ```
...
Output as of nix-from-scratch-0.38.0:
```
