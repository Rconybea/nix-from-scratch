...
[![Version](https://img.shields.io/badge/release-v0.37.1-blue)](https://github.com/Rconybea/nix-from-scratch/releases)
...
```
version=nix-from-scratch-0.37.1
...
1. Download release
  ...
  ```
  curl -L https://github.com/Rconybea/nix-from-scratch/archive/refs/tags/nix-from-scratch-0.37.1.tar.gz
  tar xf nix-from-scratch-0.37.1.tar.gz
  srcdir=nix-from-scratch-0.37.1
  ```
...
Output as of nix-from-scratch-0.37.1:
```
