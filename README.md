...
[![Version](https://img.shields.io/badge/prerelease-v0.32.0-blue)](https://github.com/Rconybea/nix-from-scratch/releases)
...
```
curl -L https://github.com/Rconybea/nix-from-scratch/archive/refs/tags/nix-from-scratch-0.32.0.tar.gz
tar xf nix-from-scratch-0.32.0.tar.gz
```
