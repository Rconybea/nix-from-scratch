...
#
# Use
#   $ cd nxfspkgs/bootstrap/nxfs-grep-0/stage0 && make compile && make install
#   $ cd nxfspkgs/bootstrap/nxfs-grep-0 && ./copy2nix.sh
...
#
cat <<EOF > default.nix
# automatically created by nix-from-scratch/nxfspkgs/bootstrap/nxfs-${name}-0/copy2nix.sh -- DO NOT EDIT
