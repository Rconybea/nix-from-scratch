...
stage0pkgs="nxfs-patchelf-0 nxfs-gnumake-0 nxfs-coreutils-0 nxfs-bash-0 nxfs-tar-0 nxfs-sed-0 nxfs-grep-0 nxfs-gawk-0 nxfs-libxcrypt-0"

for subdir in $stage0pkgs; do
    pushd $subdir
    (cd stage0 && make unpackclean)
    popd
done
